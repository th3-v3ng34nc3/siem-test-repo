...
CLOUDTRAIL_TPL="$TPL_LOC/aws-cloudtrail-collector-tpl"
...
read -p "Do you want to add CloudTrail integration $INTEGRATION_ID to tenant $TENANT_ID in $ENV_ID? (y/n): " CONFIRM
