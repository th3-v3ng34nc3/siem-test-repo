...
# 2. Set the global level and format
logging.basicConfig(
    level=logging.INFO,
    ...
    for record in event.get('Records', []):
        ...
        try:
            ...
            for item in records_list:
                # Log each record as its own log entry
...
record = {"Records":[{"s3":{"bucket":{"name":"cloudtrail-logs-956994857092-us-east-1"},"object":{"key":"AWSLogs/956994857092/CloudTrail/ap-northeast-1/2025/04/24/956994857092_CloudTrail_ap-northeast-1_20250424T2355Z_Z5PaBPI2CAPgJAIy.json.gz"}}}]}
lambda_handler(record, "d")
record = {"Records":[{"s3":{"bucket":{"name":"cloudtrail-logs-956994857092-us-east-1"},"object":{"key":"AWSLogs/956994857092/CloudTrail/us-west-1/2025/07/15/956994857092_CloudTrail_us-west-1_20250715T2325Z_sX7wdH6wRzJB8AK7.json.gz"}}}]}
lambda_handler(record, "d")